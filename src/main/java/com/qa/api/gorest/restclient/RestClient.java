...
/**
 * This class is having all http methods ,which will call the api's having generic methods 
 * for getting the response and fetch the value from the response
 * @author vasu_kichu
 *
 */
	...
	private static RequestSpecification createRequest(String contentType, Map<String, String> token,
		...
		if (contentType != null) {
			if (contentType.equalsIgnoreCase("JSON")) {
				...
				request.multiPart("image", new File("/Users/vasu_kichu/Desktop/Static_1.png"));
			}
		}
